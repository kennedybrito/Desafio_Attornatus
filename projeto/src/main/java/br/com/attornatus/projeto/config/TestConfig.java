...
import br.com.attornatus.projeto.entity.EnderecoPrincipal;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Endereco e1 = new Endereco(null, "rua fulano de tal", EnderecoPrincipal.ENDERECO_PRINCIPAL ,  "72910-000", "Goiania", 40, p2);
		Endereco e2 = new Endereco(null, "rua da ciranda", EnderecoPrincipal.ENDERECO_SECUNDARIO, "71205-000", "brasilia", 160, p2);
